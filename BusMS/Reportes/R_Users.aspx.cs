...
{
    public partial class R_Users : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_Users"];
                ...
                if (usr.Rol_ID.Contains("ADMIN"))
                    parameters[0] = new ReportParameter("rpUser", users);
                else
                {
                    parameters[0] = new ReportParameter("rpUser", usr.User_ID);
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Reporte de usuarios')", true);
        }
    }
}