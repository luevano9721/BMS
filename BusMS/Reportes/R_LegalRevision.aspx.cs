...
{
    public partial class R_LegalRevision : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_LegalRevision"];
                ...
                if (usr.Vendor_ID.Equals("ALL"))
                    parameters[0] = new ReportParameter("rpVendor", vendors);
                else
                {
                    parameters[0] = new ReportParameter("rpVendor", usr.Vendor_ID);
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Revisión Legal')", true);
        }
    }
}