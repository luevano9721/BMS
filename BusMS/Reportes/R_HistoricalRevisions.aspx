<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="R_HistoricalRevisions.aspx.cs" Inherits="BusManagementSystem.Reportes.R_HistoricalRevisions" %>
...
<style type="text/css">
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Historical_Revisions.aspx"></iframe>
    </div>
</asp:Content>
