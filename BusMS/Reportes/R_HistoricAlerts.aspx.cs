...
{
    public partial class R_HistoricAlerts : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_HistoricAlert"];
                ...
                if (usr.Vendor_ID.Equals("ALL"))
                    parameters[0] = new ReportParameter("rpVendor", vendors,true);
                else
                {
                    parameters[0] = new ReportParameter("rpVendor", usr.Vendor_ID,false);
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Histórico de alertas')", true);
        }
    }
}