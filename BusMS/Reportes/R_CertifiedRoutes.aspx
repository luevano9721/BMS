<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="R_CertifiedRoutes.aspx.cs" Inherits="BusManagementSystem.Reportes.R_CertifiedRoutes"  %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Certify_Routes.aspx"></iframe>
    </div>
</asp:Content>
