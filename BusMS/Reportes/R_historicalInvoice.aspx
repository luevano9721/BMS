<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_historicalInvoice.aspx.cs"  MasterPageFile="~/MasterPage.master"  Inherits="BusManagementSystem.Reportes.R_historicalInvoice" %>
...
<style type="text/css">
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Historical_Invoice.aspx"></iframe>
    </div>
