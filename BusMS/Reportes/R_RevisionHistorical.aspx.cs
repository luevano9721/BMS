...
{
    public partial class R_RevisionHistorical : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_HistoricalRevision"];
                ...
                if (usr.Vendor_ID.Equals("ALL"))
                    parameters[0] = new ReportParameter("rpVendorID", vendors);
                else
                {
                    parameters[0] = new ReportParameter("rpVendorID", usr.Vendor_ID);
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Histórico de mantenimiento')", true);
        }
    }
}