<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_Operation_Status.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="BusManagementSystem.Reportes.R_Operation_Status" %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/System_Close_Report.aspx"></iframe>
    </div>
