<%@ Page Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="R_HistoricalBlackList.aspx.cs" Inherits="BusManagementSystem.Reportes.R_HistoricalBlackList" %>
...
<style type="text/css">
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Historical_BlackList.aspx"></iframe>
    </div>
