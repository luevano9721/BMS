...
{
    public partial class R_CertifiedRoutes : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["R_CertifiedRoutes"];
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Reporte Rutas certificadas')", true);
        }
    }
}