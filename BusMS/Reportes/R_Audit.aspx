<%@ Page Language="C#" AutoEventWireup="true"     CodeBehind="R_Audit.aspx.cs" Inherits="BusManagementSystem.Reportes.R_Audit"     MasterPageFile="~/MasterPage.Master"%>
...
<style type="text/css">
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Audit_Historical.aspx"></iframe>
    </div>
</asp:Content>