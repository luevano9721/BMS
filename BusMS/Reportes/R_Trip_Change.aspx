<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_Trip_Change.aspx.cs"  MasterPageFile="~/MasterPage.master" Inherits="BusManagementSystem._20Reportes.R_Trip_Change" %>
...
<style type="text/css">
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Daily_Operation_Changes.aspx"></iframe>
    </div>
</asp:Content>
