<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_LegalRevision.aspx.cs" MasterPageFile="~/MasterPage.master"  Inherits="BusManagementSystem.Reportes.R_LegalRevision" %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Legal_Revision_Report.aspx"></iframe>
    </div>
