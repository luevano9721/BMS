<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_ActivityLog.aspx.cs"  MasterPageFile="~/MasterPage.master" Inherits="BusManagementSystem._20Reportes.R_ActivityLog" %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Activity_Log_Report.aspx"></iframe>
    </div>
