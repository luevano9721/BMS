<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_DailyOperation.aspx.cs" MasterPageFile="~/MasterPage.master" Inherits="BusManagementSystem._20Reportes.R_Viewer" %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Daily_Operation_Report.aspx"></iframe>
    </div>
