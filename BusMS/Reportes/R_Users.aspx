<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_Users.aspx.cs"  MasterPageFile="~/MasterPage.master" Inherits="BusManagementSystem.Reportes.R_Users" %>
...
<style type="text/css">
    ...
    <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border: none" width="100%" height="100%" src="../Documentation/Historical_Users.aspx"></iframe>
    </div>
</asp:Content>
