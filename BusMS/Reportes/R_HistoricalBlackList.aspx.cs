...
{
    public partial class R_HistoricalBlackList : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                load_HistoricalBlackList();
            }
        ...
        private void load_HistoricalBlackList()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_HistoricalBlackList"];
                ...
                //HistoricalReport_Revisions.rdl
