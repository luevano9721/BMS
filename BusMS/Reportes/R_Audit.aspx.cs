...
{
    public partial class R_Audit : System.Web.UI.Page
    {
        ...
        private void load_DailyOperationReport()
        {
            ...
            try
            {
                ...
                string sReportPath_1 = ConfigurationManager.AppSettings["r_Audit"];
        ...
        protected void btHelp_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterStartupScript(this.Page, Page.GetType(), "text", "BMSHelp('Ayuda - Reporte Auditorias')", true);
        }
    }
}