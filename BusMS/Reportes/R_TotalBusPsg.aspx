<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="R_TotalBusPsg.aspx.cs" Inherits="BusManagementSystem.Reportes.R_TotalBusPsg" MasterPageFile="~/MasterPage.master" %>
...
<style type="text/css">
    ...
    <span class="badge  pull-right" style="background-color:white;"><asp:LinkButton ID="btHelp" runat="server" OnClick="btHelp_Click" CausesValidation="false"><i class="icon-question-sign"></i></asp:LinkButton></span>
    ...
    <asp:ScriptManager ID="ScriptManager_ActLog" runat="server"></asp:ScriptManager>
     ...
     <div id="dialogHelp" style="display: none;" title="Help">
        <iframe style="border:none" width="100%" height="100%" src="../Documentation/Buses_Pgs_Overtime_Report.aspx"></iframe>
    </div>
</asp:Content>
